...
- [x] 앨범 커버 설정 기능: 사진 썸네일 hover 시 "커버로 설정" 버튼, 현재 커버에 배지 표시 <!-- 2026-06-16 완료 -->
- [x] 앨범 목록 화면에서 앨범 커버 표시 <!-- 2026-06-16 완료 -->
- [x] 공유 링크 hash 길이 단축: uuid4 → secrets.token_hex(5) (10자) <!-- 2026-06-16 완료 -->
- [x] 만료일 timezone 버그 수정: datetime-local → date 입력, T23:59:59 UTC 명시 <!-- 2026-06-16 완료 -->
