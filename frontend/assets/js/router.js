...
import { renderAdminTags, renderAdminTagPhotos } from './pages/admin-tags.js';
...
import { renderSlideshow, renderPersonSlideshow } from './pages/slideshow.js';
...
const ROUTES = [
  ...
  { path: '/admin/tags',         render: () => renderAdminTags(),      public: false },
  { path: '/admin/tags/photos',  render: () => renderAdminTagPhotos(), public: false },
...
const DYNAMIC_ROUTES = [
  ...
  { pattern: /^\/admin\/people\/(\d+)\/photos$/,    render: (m) => renderAdminPersonPhotos(m[1]),  public: false },
  { pattern: /^\/admin\/people\/(\d+)\/slideshow$/, render: (m) => renderPersonSlideshow(m[1]),    public: false },
